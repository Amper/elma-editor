...
export interface TopologyError {
    type: 'edge-intersection' | 'self-intersection' | 'missing-start' | 'missing-flower' | 'multiple-starts' | 'object-in-ground' | 'too-many-polygons' | 'too-many-vertices' | 'too-many-objects' | 'too-many-sprites' | 'level-too-large' | 'overlapping-polygons';
